<?php
   ...
   $sql="SELECT `paymentID`,`payments`.`tenantID`,`tenant_name`,`house_name`,`invoiceNumber`,`expectedAmount`,`amountPaid`,`balance`,`mpesaCode`,`dateofPayment`,`comment` FROM `payments` LEFT JOIN `tenantsView` ON `payments`.`tenantID`=`tenantsView`.`tenantID`";
   */
                                ...
                                <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                                    ...
                                    echo '
                                        ...
                                        <tr>
                                            ...
                                            <!-- /.modal -->
                                            <div id="responsive-modal'.$row["paymentID"].'" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
